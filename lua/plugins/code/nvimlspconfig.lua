  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        map('gD', vim.lsp.buf.definition, 'Goto [D]efinition (LSP)')
        ...
        map('<leader>sds', require('telescope.builtin').lsp_document_symbols, 'Document [s]ymbols')
    ...
    local servers = {
      ...
      -- NOTE: More Cucumber LSP removed
      ...
      --     cucumber = {
      --       features = { '**/*.feature' },
      --       glue = { '**/step_definitions/**/*.js', '**/step_definitions/**/*.ts' },
      --     },
      --   },
      ...
      --     vim.keymap.set('n', '<C-k>', vim.lsp.buf.definition, { buffer = 0 })
      --   end,
      -- },
